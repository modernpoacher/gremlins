...
import Gremlin from '@modernpoacher/gremlins/gremlins/text'

import Field from '@modernpoacher/gremlins/gremlins/text/field'
...
jest.mock('@modernpoacher/gremlins/gremlins/text/field')

describe('@modernpoacher/gremlins/gremlins/text', () => {
  describe('<Gremlin />', () => {
